    ...
    var functions = {
        ...
        splitchat: function() {
            if (!options.splitchat) {
                functions.enable('.splitchat');
                functions.storage('splitchat', 'true');
                ...
                functions.disable('.splitchat');
                functions.storage('splitchat', 'false');
        ...
        showtimestamp: function() {
            if (!options.showtimestamp) {
                functions.enable('.showtimestamp');
                functions.storage('showtimestamp', 'true');
                ...
                functions.disable('.showtimestamp');
                functions.storage('showtimestamp', 'false');
        ...
        notifionmention: function() {
            if(!options.notifionmention) {
                options.notifionmention = true;
                functions.enable('.notifionmention');
                functions.storage('notifionmention','true');
            } else {
                options.notifionmention = false;
                functions.disable('.notifionmention');
                functions.storage('notifionmention','false');
            }
        },
        userudub: function() {
            if(!options.userudub) {
        ...
        notifyonmention: function(e){
            if (options.notifionmention) {
                ...
                if (mentionTriggers.some(function(v) {
                    ...
                    functions.desktopnotif('You were mentioned by '+username+'', ''+message+'');
                }
            }
        },
        desktopnotif: function(title, body) {
