...
function append() {
    ...
    setTimeout(function() {
        $('.chat-main').append('<li class="chat-welcome-message" style="text-align: center; color: #CCC;"><br><br><br><span>CMS Version - '+version+'</span><br><span>'+motd+'</span><br><br><br></li>');
